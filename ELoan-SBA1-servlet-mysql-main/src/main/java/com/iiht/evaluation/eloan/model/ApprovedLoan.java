...
public class ApprovedLoan {
	...
	public ApprovedLoan(String applno, int amotsanctioned, int loanterm, String psd, String lcd,
			double termpaymentamount, int emi, double interestrate) {
		super();
		this.applno = applno;
		this.amotsanctioned = amotsanctioned;
		this.loanterm = loanterm;
	...
	public String toString() {
		return "ApprovedLoan [applno=" + applno + ", amotsanctioned=" + amotsanctioned + ", loanterm=" + loanterm
				+ ", psd=" + psd + ", lcd=" + lcd + ", termpaymentamount=" + termpaymentamount + ", emi=" + emi

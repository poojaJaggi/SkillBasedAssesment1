...
private ConnectionDao connDao;
	...
	/* write the code to place the loan information */
		...
		System.out.println(session.getAttribute("todayDate").toString());
		...
		loanInfo.setDoa(session.getAttribute("todayDate").toString());
	...
	private String registernewuser(HttpServletRequest request, HttpServletResponse response) throws SQLException {
		...
		String userName = request.getParameter("firstname").substring(0, 2) + request.getParameter("lastname").substring(0, 2) + request.getParameter("dob").split("-")[2];
